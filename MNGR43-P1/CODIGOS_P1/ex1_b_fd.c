/*
  ...
  gcc -g -Wall -O3 -o ex1_b_fd ex1_b_fd.c -lm
  Compilar con  sintaxis standard ANSI C del 1990
  gcc -g -Wall -pedantic -o ex1_b_fd ex1_b_fd.c -lm
*/
