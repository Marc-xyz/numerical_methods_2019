 ...
 *NOMBRE FICHERO:int_03_L.c                                         *
 *DESCRIPCIÓN: Programa para calcular numéricamente la integral     * 
 *                                                                  *
 *          ______________                                          *
 *   / 1   |             |                                          *
 *  |      |  64-15x^2              mediante cuadratura de          *
 *  |      |  ---------    dx       Gauss-Legendre.Con precisión    *
 *  |     \|  64-16x^2              máxima de 15 decimales          *                     
 *  / -1                            correctos.                      *
 ********************************************************************/

                 /***********************COMPILE**********************
                 *  Compilar con  nivel de optimización 3            *
                 *  gcc -g -Wall -O3 -o int_03_L int_03_L.c -lm      * 
                 *  Compilar con  sintaxis standard ANSI C del 1990  *
                 *  gcc -g -Wall -pedantic -o int_03_L int_03_L.c -lm*
                 * ***************************************************/
...
#define F(x) sqrt((64.0-15.0*x*x)/(64.0-16.0*x*x)) //FUNCIÓN A INTEGRAR f(x):=e^(-x^2)
